...
export default function ChatUI() {
  ...
  const quick = [
    ...
    },
    {
      ...
      prompt:
        "Create a Notion task in the Tasks DB from the last user message.",
    },
  ];
  ...
  return (
    ...
    >
      <div
        className="flex gap-2 p-2 border-b overflow-x-auto"
      ...
      >
        ...
        {loading && (
          <div className="text-sm" style={{ color: palette.charcoal }}>
            Thinking…
          </div>
        )}
      </div>
