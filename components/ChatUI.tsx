...
const palette = {
  // brand colors: env overrides, fall back to our defaults
  ...
  const quick = [
    {
      ...
      prompt: 'Sync Stripe and Notion (two-way)',
    },
    {
      label: 'Generate on-brand images',
      prompt: 'Generate on-brand images for the selected product',
    },
    {
      label: 'Audit Stripe products',
      prompt: 'Audit Stripe products and propose fixes',
    },
    {
      label: 'Create Notion task for Maggie',
      prompt: 'Create a Notion task for Maggie based on this chat',
    },
  ];
