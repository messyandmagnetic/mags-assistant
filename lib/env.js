export const env = {
  ...
  DEFAULT_MARKUP_PERCENT: process.env.DEFAULT_MARKUP_PERCENT,
  DEFAULT_ROUNDING: process.env.DEFAULT_ROUNDING,
  DEFAULT_CURRENCY: process.env.DEFAULT_CURRENCY,
  PRICE_AUDIT_MIN: process.env.PRICE_AUDIT_MIN,
  PRICE_AUDIT_MAX: process.env.PRICE_AUDIT_MAX,
  NOTION_PRICE_RULES_DB_ID: process.env.NOTION_PRICE_RULES_DB_ID,
