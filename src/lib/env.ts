...
const envSchema = z.object({
  ...
  DEFAULT_MARKUP_PERCENT: z.string().optional(),
  DEFAULT_ROUNDING: z.string().optional(),
  DEFAULT_CURRENCY: z.string().optional(),
  PRICE_AUDIT_MIN: z.string().optional(),
  PRICE_AUDIT_MAX: z.string().optional(),
  NOTION_PRICE_RULES_DB_ID: z.string().optional(),
